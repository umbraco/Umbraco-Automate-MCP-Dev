...
export const toolSliceNames = [
  ...
  // Automate-specific
  'action',    // non-CRUD state-transition operations (trigger, suspend, replay, decision, test, etc.)
  'publish',   // publish/unpublish operations
  'tree',      // hierarchical/ancestor lookups
  'export',    // export to portable format
  'import',    // import from portable format
] as const;
